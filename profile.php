        ...
        <div class="p-0 container-fluid">
            <div class="row">
                <div class="col-xl-3 col-md-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="mb-0 card-title h5">About</div>
                        </div>
                        <hr class="my-0">
                        <div class="card-body">
                            <ul class="list-unstyled mb-0">
                                <li class="mb-1"><strong>Pub ID:</strong> 929</li>
                                <li class="mb-1"><strong>Email:</strong> lrtechnologyltd@gmail.com</li>
                                <li class="mb-1"><strong>Status:</strong> <span class="badge bg-success">Active</span></li>
                                <li class="mb-1"><strong>Created:</strong> 07-Mar-2024 05:14:40</li>
                                <li class="mb-1"><strong>Updated:</strong> 07-Mar-2024 05:17:16</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-md-6 col-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="mb-0 card-title h5">General info</div>
                        </div>
                        <div class="card-body">
                            <form class="">
                                <div class="mb-3"><label class="form-label">Name</label><input name="name" disabled="" type="name" class="form-control form-control-lg" value="LR Technology"></div>
                                <div class="mb-3"><label class="form-label">Company</label><input name="company" disabled="" type="name" class="form-control form-control-lg" value="LR Technology"></div>
                            </form>
                        </div>
                    </div>
                </div>
